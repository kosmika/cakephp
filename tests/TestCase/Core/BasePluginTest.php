...
class BasePluginTest extends TestCase
{
    ...
    /**
     * A plugin that declares `$eventListeners` requires the host application to
     * expose a container; bare PluginApplicationInterface implementations
     * should fail with a clear error.
     */
    public function testEventListenersRequireContainerApplicationInterface(): void
    {
        $app = new class implements PluginApplicationInterface {
            use BasePluginApplicationTrait;
        };
        ...
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageMatches('/ContainerApplicationInterface/');
        $plugin->bootstrap($app);
    }
}
